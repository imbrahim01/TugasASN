...
with st.sidebar:
    selected = option_menu("TUGAS 1", ["Home","Ecyclopedia", "Data & Graphic", "Filter","Method","HRV Analysis"], icons=['house', 'book',none,none,'heartbeat'], menu_icon="cast", default_index=1)
