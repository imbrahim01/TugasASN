...
with st.sidebar:
    selected = option_menu("TUGAS 1", ["Home","Ecyclopedia", "Data & Graphic", "Filter","Method","HRV Analysis"], icons=['house', 'book',None,None,None,'HeartRate'], menu_icon="cast", default_index=1)
